...
//    })
  ...
  methods:{
    initChart:function(){
      ...
      this.$ajax.post('http://'+this.server +':8084/file/getMineInfoByCounty?county=' + this.county).then(res =>{
        console.log(res)
        for(var i = 0; i < res.data.listOne.length; i ++){
          meiMes.shaftArea += parseFloat(res.data.listOne[i].shaftArea);
          meiMes.cout ++;
          meiMes.designProducePower += parseFloat(res.data.listOne[i].realProducePower);
          meiMes.realProducePower += parseFloat(res.data.listOne[i].designProducePower);
          meiMes.reserves += parseFloat(res.data.listOne[i].reserves);
        }
        for(var i = 0; i < res.data.listTwo.length; i ++){
          feiMes.shaftArea += parseFloat(res.data.listTwo[i].shaftArea);
          feiMes.cout ++;
          feiMes.designProducePower += parseFloat(res.data.listTwo[i].realProducePower);
          feiMes.realProducePower += parseFloat(res.data.listTwo[i].designProducePower);
          feiMes.reserves += parseFloat(res.data.listTwo[i].reserves);
        }
          ...
          series : [
            {
              ...
              type:'bar',
              barWidth: '40%',
              data:[meiMes.cout.toFixed(2), feiMes.cout.toFixed(2)]
            }
          ]
        });
          ...
          series : [
            {
              ...
              center: ['50%', '65%'],
              data:[
                {value:meiMes.shaftArea.toFixed(2), name:'煤矿'},
                {value:feiMes.shaftArea.toFixed(2), name:'非煤矿'},
              ],
              itemStyle: {
                emphasis: {
                  shadowBlur: 10,
          ...
          series: [
            {
              ...
              type: 'bar',
              label: labelOption,
              data: [meiMes.realProducePower.toFixed(2), feiMes.realProducePower.toFixed(2)]
            },
            {
              name: '设计生产力',
              type: 'bar',
              barGap: 0,
              label: labelOption,
              data: [meiMes.designProducePower.toFixed(2), feiMes.designProducePower.toFixed(2)]
            }
          ]
        });
          ...
          series : [
            {
              ...
              center: ['50%', '65%'],
              data:[
                {value:meiMes.reserves.toFixed(2), name:'煤矿'},
                {value:feiMes.reserves.toFixed(2), name:'非煤矿'},
              ],
              itemStyle: {
                emphasis: {
                  shadowBlur: 10,
