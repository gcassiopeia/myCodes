    ...
    <div class="right">
      <div class="contain">
        <table class="table table-striped">
          ...
          <tr>
            <td>废弃场地</td>
            <td>{{this.problem.feiqinum}}</td>
            <td>{{this.problem.feiqi}}</td>
          </tr>
          <tr>
            <td>边坡</td>
            <td>{{this.problem.bianponum}}</td>
            <td>{{this.problem.bianpo}}</td>
          </tr>
          <tr>
            <td>采空区</td>
            <td>{{this.problem.caikongnum}}</td>
            <td>{{this.problem.caikong}}</td>
          </tr>
          <tr>
            <td>沉陷区</td>
            <td>{{this.problem.chenxiannum}}</td>
            <td>{{this.problem.chenxian}}</td>
          </tr>
          <tr>
            <td>地裂缝</td>
            <td>{{this.problem.dilienum}}</td>
            <td>{{this.problem.dilie}}</td>
          </tr>
          <tr>
            <td>矸石场</td>
            <td>{{this.problem.ganshinum}}</td>
            <td>{{this.problem.ganshi}}</td>
          </tr>
          <tr>
            <td>工业场地</td>
            <td>{{this.problem.gongyenum}}</td>
            <td>{{this.problem.gongye}}</td>
          </tr>
          <tr>
            <td>采石场</td>
            <td>{{this.problem.caishinum}}</td>
            <td>{{this.problem.caishi}}</td>
          </tr>
          <tr>
            <td>堆煤场</td>
            <td>{{this.problem.duimeinum}}</td>
            <td>{{this.problem.duimei}}</td>
          </tr>
          <tr>
            <td>排土场</td>
            <td>{{this.problem.paitunum}}</td>
            <td>{{this.problem.paitu}}</td>
          </tr>
          <tr>
            <td>取土场</td>
            <td>{{this.problem.qutunum}}</td>
            <td>{{this.problem.qutu}}</td>
          </tr>
          <tr>
            <td>露天采场</td>
            <td>{{this.problem.lutiannum}}</td>
            <td>{{this.problem.lutian}}</td>
          </tr>
          </tbody>
        </table>
      </div>
...
//          meiMes.reserves += parseInt(res.data.listOne[i].reserves.replace(/[^0-9]/ig,""));
//        }
...
//          feiMes.reserves += parseInt(res.data.listTwo[i].reserves.replace(/[^0-9]/ig,""));
//        }
...
//      })
      ...
      var feiqi = this.problem.feiqi;
      var bianpo = this.problem.bianpo;
      ...
      this.chart1Option = {
        ...
        series: [{
          data: [this.problem.feiqi, this.problem.bianpo, this.problem.caikong , this.problem.chenxian , this.problem.dilie , this.problem.ganshi , this.problem.gongye , this.problem.caishi , this.problem.duimei , this.problem.paitu , this.problem.qutu , this.problem.lutian],
          type: 'bar'
        }]
      };
