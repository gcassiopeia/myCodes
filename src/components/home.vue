...
<!--<script>-->
  ...
  <!--mounted:function() {-->
    ...
    <!--// 初始化地图,设置中心点坐标和地图级别-->
    <!--map.centerAndZoom("吕梁",12);-->
    <!--map.setMapStyle({styleJson:styleJson});-->
    <!--// 添加地图类型控件-->
    <!--map.addControl(new BMap.MapTypeControl());-->
    <!--// 设置地图显示的城市 此项是必须设置的-->
    <!--map.setCurrentCity("吕梁");-->
    <!--// 开启鼠标滚轮缩放-->
...
<!--//    },6000);-->
    ...
    <!--ZoomControl.prototype.initialize = function(map) {-->
      ...
      <!--}-->
      <!--var point = new BMap.Point( 37.2901,112.0257);-->
      ...
      series : [
        {
          ...
          zoom:1.25,
          itemStyle:{
            normal:{label:{show:true}},    //地图初始化城市名称是否展示
    ...
    myChart.on('click', function (params) {
      switch(params.name){
        case '兴县' :
          ...
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市兴县',}});break;
        case '岚县' :
//          var z_tree = [];
//          z_tree.push(8);
//          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市岚县',}});break;
        case '临县' :
          var z_tree = [];
          z_tree.push(7);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市临县',}});break;
        case '方山县' :
//          var z_tree = [];
//          z_tree.push(8);
//          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市方山县',}});break;
        case '柳林县' :
          var z_tree = [];
          z_tree.push(3);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市柳林县',}});break;
        case '离石区' :
//          var z_tree = [];
//          z_tree.push(8);
//          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市离石区',}});break;
        case '交城县' :
          var z_tree = [];
          z_tree.push(6);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市交城县',}});break;
        case '石楼县' :
//          var z_tree = [];
//          z_tree.push(8);
//          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市石楼县',}});break;
        case '中阳县' :
          var z_tree = [];
          z_tree.push(10);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市中阳县',}});break;
        case '汾阳市' :
          var z_tree = [];
          z_tree.push(4);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市汾阳市',}});break;
        case '文水县' :
          var z_tree = [];
          z_tree.push(2);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市文水县',}});break;
        case '孝义市' :
          var z_tree = [];
          z_tree.push(9);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市孝义市',}});break;
        case '交口县' :
          var z_tree = [];
          z_tree.push(5);
          Cookies.set('z_tree',z_tree);
          self.$router.push({path:'/home/map_county', query:{county:'吕梁市交口县',}});break;
      }
    });
  }
